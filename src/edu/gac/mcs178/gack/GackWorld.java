...
public class GackWorld extends World {
	...
	public GackWorld() {
		...
		//make Lund a new neighbor for dormitory in the Northwest direction
		...
		new Necromancer("Larry the Necromancer", goodShipOlin, 1);
		...
		// add a new scroll and put it in Lund
